...
export const USER: User = {
  firstName: "Michael",
  lastName: "Lo",
  displayName: "Michael Lo",
  username: "Michael0520",
  gender: "male",
  pronouns: "he/him",
  bio: "Full Stack Web Developer passionate about creating efficient, high-performance solutions.",
  flipSentences: [
...
> Coding is my way of making tomorrow a little lazier.`,
  ...
  dateCreated: "2026-04-01", // YYYY-MM-DD
};
