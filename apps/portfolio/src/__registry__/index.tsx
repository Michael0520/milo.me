...
export const Index: Record<string, any> = {
  ...
  "chevrons-up-down-icon": {
    ...
    component: React.lazy(async () => {
      const mod =
        await import("@/registry/components/chevrons-up-down-icon/chevrons-up-down-icon.tsx");
      const exportName =
        Object.keys(mod).find(
          (key) => typeof mod[key] === "function" || typeof mod[key] === "object",
        ) || item.name;
  ...
  "testimonial-spotlight": {
    ...
    component: React.lazy(async () => {
      const mod =
        await import("@/registry/components/testimonial-spotlight/testimonial-spotlight.tsx");
      const exportName =
        Object.keys(mod).find(
          (key) => typeof mod[key] === "function" || typeof mod[key] === "object",
        ) || item.name;
