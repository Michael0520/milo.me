      ...
      <TOCMinimapContainer className={cn("ml-auto w-18", className)}>
        ...
        >
          <HoverCardTrigger
            ...
            closeDelay={0}
            render={
              <div className="flex max-h-[80dvh] flex-col gap-3 overflow-hidden py-3 pl-6 opacity-100 transition-opacity duration-200 data-popup-open:opacity-0">
                <Minimap />
              </div>
            }
          />
          ...
          >
            <div className="flex max-h-[80dvh] overflow-y-auto overscroll-contain">
              <TOCList />
            </div>
          </HoverCardContent>
        </HoverCard>
      ...
      {items.map((item) => (
        <li key={item.id} className="flex py-1">
          <a
            ...
            data-active={item.active}
            className={cn(
              "line-clamp-2 w-full transition-[color] duration-200 ease-out",
